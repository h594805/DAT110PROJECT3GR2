...
public class FileManager {
	...
	public void createReplicaFiles() {
		...
		/*
		 * Bruker en for-løkke som fortsetter like mange ganger som numReplicas, hvor vi
		 * tar navnet på den replikerte filen og legger til i slik at filnavnet blir
		 * nummerert (0, 1, 2, 3, ... )
		 */
		...
		for (int i = 0; i < numReplicas; i++) {
			...
			/*
			 * Bruker hashOf()-metoden fra Hash.java til å hash'e replika filen og legge den
			 * inn i en BigInteger (replicaHashed).
			 */

			BigInteger replicaHashed = Hash.hashOf(replicaFileName);

			/*
			 * Lagrer den hashede filen inn i replicafiles.
			 */

			replicafiles[i] = replicaHashed;
